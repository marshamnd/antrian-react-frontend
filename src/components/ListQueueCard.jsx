...
function ListQueueCard({ queue }) {
  const colorClass =
    polyclinicColors[queue.polyclinic] || "bg-gray-100 border-gray-500"; // Default warna jika poliklinik tidak dikenal
  ...
  return (
    ...
    >
      <h2 className="text-xl font-bold text-gray-700">{queue.queue_number}</h2>
    </div>
  );
}

export default ListQueueCard;
